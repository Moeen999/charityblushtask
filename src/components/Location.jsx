...
const Location = () => {
  return (
    <div className="max-w-8xl mx-auto">
      <div className="text-center mb-12 md:mb-16 aos-init aos-animate">
      ...
      {/* MAP */}
      <div className="bg-white rounded-2xl overflow-hidden shadow-2xl border border-gray-100 transition-all duration-300 hover:shadow-2xl aos-init aos-animate">
